...
/// </summary>
public class ARModelBehaviour : MonoBehaviour
{
    ...
    IEnumerator playAudio()
    {
        ...
        using (UnityWebRequest www = UnityWebRequestMultimedia.GetAudioClip(audioLink, AudioType.MPEG))
        {
    ...
    private Boolean isSourceChanged()
    {
        ...
        string theLink = videoARScript.passAudioLink();

        if (audioLink != theLink)
        {
            audioLink = theLink;
            return true;
        }
